...
public class ControlFragment extends Fragment implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // layout root du fragment
    private FrameLayout rootLayout;

    private static TextView tvAccX, tvAccY;
    ...
    private static final String xString = "X: ", yString = "Y: ";
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, final ViewGroup container,
        ...
        tvAccX = rootView.findViewById(R.id.tv_accX);
        tvAccY = rootView.findViewById(R.id.tv_accY);

        // instancier les sharedPreferences
        sharedPreferences = androidx.preference.PreferenceManager.getDefaultSharedPreferences(rootView.getContext());
    ...
    private void setTheme() {
        ...
        if (sharedPreferences.getBoolean("dark_theme_key", false)) {
            ...
            // mettre le background en foncé
            rootLayout.setBackgroundColor(Color.GRAY);

            // sinon mettre le background en clair
        } else {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_up:
                ...
                if (MainActivity.bluetoothConnected) {
                    ...
                    // faire avancer le robot si se n'est pas déjà fait
                    if (!command.equals("forward"))
                        new forward().execute();
                }
                break;
            ...
            case R.id.btn_down:
                ...
                if (MainActivity.bluetoothConnected) {
                    ...
                    // faire reculer le robot si se n'est pas déjà fait
                    if (!command.equals("backward"))
                        new backward().execute();
                }
                break;
            ...
            case R.id.btn_left:
                ...
                if (MainActivity.bluetoothConnected) {
                    ...
                    // faire tourner le robot à gauche si se n'est pas déjà fait
                    if (!command.equals("turnLeft"))
                        new turnLeft().execute();
                }
                break;
            ...
            case R.id.btn_right:
                ...
                if (MainActivity.bluetoothConnected) {
                    ...
                    // faire tourner le robot à droite si se n'est pas déjà fait
                    if (!command.equals("turnRight"))
                        new turnRight().execute();
                }
                break;
            ...
            case R.id.btn_stop:
                ...
                if (MainActivity.bluetoothConnected) {
                    ...
                    // arrêter le robot si se n'est pas déjà fait
                    if (!command.equals("stop"))
                        stop();
                }
                break;
    ...
    public static class forward extends AsyncTask<Void, String, Void> {

        String xFinal, yFinal;
    ...
    public static class backward extends AsyncTask<Void, String, Void> {
    ...
    public static class turnLeft extends AsyncTask<Void, String, Void> {
    ...
    public static class turnRight extends AsyncTask<Void, String, Void> {
